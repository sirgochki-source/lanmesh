...
// --- определение шлюза (единственный syscall в пакете) ---
//
...
// собственно UDP-пакетах PCP/NAT-PMP/UPnP ниже (там encoding/binary.BigEndian
// по прямому смыслу сетевого порядка байт); две конвенции разные и путать их
// нельзя.
